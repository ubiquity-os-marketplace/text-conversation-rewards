...
const htmlType = Type.Record(Type.String(), htmlEntity, {
  ...
  default: {
    br: { score: 1, countWords: true },
    code: { score: 1, countWords: false },
    p: { score: 1, countWords: true },
    em: { score: 1, countWords: true },
    img: { score: 1, countWords: true },
    strong: { score: 1, countWords: false },
    blockquote: { score: 1, countWords: false },
    ...
    a: { score: 1, countWords: true },
    li: { score: 1, countWords: true },
    ul: { score: 1, countWords: true },
    td: { score: 1, countWords: true },
    hr: { score: 1, countWords: true },
    pre: { score: 1, countWords: false },
    ol: { score: 1, countWords: true },
    b: { score: 1, countWords: true },
    summary: { score: 1, countWords: false },
    details: { score: 1, countWords: false },
    table: { score: 1, countWords: false },
  },
});
...
const rewardsType = Type.Object(
  {
    html: htmlType,
    wordValue: Type.Number({ default: 1, description: "Value multiplier for each word" }),
  },
  { default: {} }
);
          ...
          default: [
            {
              ...
              multiplier: 1,
              rewards: { wordValue: 1, html: htmlType.default },
            },
            {
              role: ["ISSUE_AUTHOR"],
              multiplier: 1,
