...
const htmlType = Type.Record(Type.String(), htmlEntity, {
  ...
  default: {
    ...
    code: { score: 0, countWords: false },
    p: { score: 0, countWords: true },
    em: { score: 0, countWords: true },
    img: { score: 0, countWords: true },
    strong: { score: 0, countWords: false },
    blockquote: { score: 0, countWords: false },
    h1: { score: 0, countWords: true },
    h2: { score: 0, countWords: true },
    h3: { score: 0, countWords: true },
    h4: { score: 0, countWords: true },
    h5: { score: 0, countWords: true },
    h6: { score: 0, countWords: true },
    a: { score: 0, countWords: true },
    li: { score: 0, countWords: true },
...
const rewardsType = Type.Object(
  {
    html: htmlType,
    wordValue: Type.Number({ default: 0, description: "Value multiplier for each word" }),
  },
  { default: {} }
);
