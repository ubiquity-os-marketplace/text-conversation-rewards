...
export function openAiType(overrides?: { model?: string; endpoint?: string }) {
  return Type.Object(
    {
      /**
       ...
       */
      model: Type.String({
        default: overrides?.model ?? "anthropic/claude-3.7-sonnet",
      ...
      endpoint: Type.String({
        default: overrides?.endpoint ?? "https://openrouter.ai/api/v1",
